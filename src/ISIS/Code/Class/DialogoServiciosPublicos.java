 ...
 * @author Jose
 */
public class DialogoServiciosPublicos extends javax.swing.JDialog {

	/**
	 * Creates new form Dialogo
	 */
	public DialogoServiciosPublicos(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
	...
	private void initComponents() {
		...
		buttonComprar1.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				setSeleccionada("ambulatorioBarrioAdentro");
				gamepanel.setConstruir(false);
		...
		lblEdif1.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 1/lblAmbulatorio.png")));
		...
		buttonComprar2.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("companiaAseoUrbano");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		lblEdif2.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 1/lblAseo.png")));
		...
		lblEdif3.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 1/lblElectricidad.png")));
		...
		buttonComprar3.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("plantaElectricidad");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		lblEdif4.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 1/lblEscuela.png")));
		...
		buttonComprar4.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("escuelaSimonRodriguez");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		lblEdif5.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 1/lblAgua.png")));
		...
		jLabel6.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 2/lblconsejoComunal.png")));
		...
		buttonSeven6.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("consejoComunal");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel7.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 2/lblestacionBomberos.png")));
		...
		buttonSeven7.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("estacionBomberos");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel8.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 2/lblliceoLibertador.png")));
		...
		buttonSeven8.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("liceoLibertador");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel9.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 2/lblmoduloPolicial.png")));
		...
		buttonSeven9.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("moduloPolicial");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel10.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 2/lbltelefonicaCantv.png")));
		...
		buttonSeven10.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("telefonicaCantv");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel11.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 3/lblcdi.png")));
		...
		jLabel12.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 3/lblcentralHidroelectrica.png")));
		...
		buttonSeven12.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("centralHidroelectrica");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel13.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 3/lblcooperativaTaxis.png")));
		...
		buttonSeven13.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("cooperativaTaxis");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel14.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 3/lblgobernacionMerida.png")));
		...
		buttonSeven14.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("gobernacionMerida");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel15.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 3/lbluniversidadBolivariana.png")));
		...
		buttonSeven15.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("universidadBolivariana");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel16.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 4/lblcatedralMerida.png")));
		...
		buttonSeven16.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("catedralMerida");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel17.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 4/lblestacionPolicia.png")));
		...
		buttonSeven17.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("estacionPolicia");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel18.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 4/lblpanteonNacional.png")));
		...
		buttonSeven18.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("panteonNacional");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel19.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 4/lblradioEstereo.png")));
		...
		jLabel20.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 4/lblterminalPrivado.png")));
		...
		buttonSeven20.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				dispose();
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("terminalPrivado");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel21.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 5/lblaeropuertoInternacional.png")));
		...
		buttonSeven21.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("aeropuertoInternacional");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
		...
		jLabel22.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 5/lblcarcelSanJuan.png")));
		...
		jLabel23.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 5/lblgaleriaCenter.png")));
		...
		jLabel24.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 5/lblhospitalHULA.png")));
		...
		jLabel25.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/ServiciosPublicos/Nivel 5/lbluniversidadAndes.png")));
		...
		buttonSeven25.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("universidadAndes");
				gamepanel.setConstruir(false);
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
	...
	public static void setSeleccionada(String seleccionada) {
		DialogoServiciosPublicos.seleccionada = seleccionada;
	}
	...
	public static void setVivienda(Construccion vivienda) {
		DialogoServiciosPublicos.vivienda = vivienda;
	}
	...
	public static void main(String[] args) {
		...
		DialogoServiciosPublicos dialogo = new DialogoServiciosPublicos(frame,
				false);
