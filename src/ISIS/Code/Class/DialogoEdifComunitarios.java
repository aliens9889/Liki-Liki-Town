 ...
 * @author Jose
 */
public class DialogoEdifComunitarios extends javax.swing.JDialog {

	/**
	 * Creates new form Dialogo
	 */
	public DialogoEdifComunitarios(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
	...
	private void initComponents() {
		...
		lblEdif1.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 1/lblEscenario.png")));
		...
		lblEdif2.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 1/lblParqueMucuy.png")));
		...
		lblEdif3.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 1/lblParqueNiños.png")));
		...
		lblEdif4.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 1/lblParqueIsla.png")));
		...
		lblEdif5.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 1/lblCanchaVoleibol.png")));
		...
		jLabel6.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 2/lblbillar.png")));
		...
		jLabel7.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 2/lblcinex.png")));
		...
		jLabel8.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 2/lblpistaPatinaje.png")));
		...
		jLabel9.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 2/lblplaza.png")));
		...
		jLabel10.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 2/lblteatro.png")));
		...
		jLabel11.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 3/lblfisicPower.png")));
		...
		jLabel12.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 3/lblmuseo.png")));
		...
		jLabel13.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 3/lblpatinajeHielo.png")));
		...
		jLabel14.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 3/lblpiscina.png")));
		...
		jLabel16.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 4/lblestadioBeisbol.png")));
		panelCurves5.add(jLabel14);
		jLabel14.setBounds(220, 70, 189, 100);
		...
		buttonSeven16.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("estadioBeisbol");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel17.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 4/lblestadioCarrera.png")));
		...
		buttonSeven17.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("estadioCarrera");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel18.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 4/lblparqueEcologico.png")));
		...
		buttonSeven18.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("parqueEcologico");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel21.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 5/lblestadioGigante.png")));
		panelCurves2.add(jLabel18);
		jLabel18.setBounds(30, 260, 189, 100);
		...
		buttonSeven21.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("estadioGigante");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel22.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 5/lblhotelIberia.png")));
		...
		jLabel23.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 5/lbljardinBotanico.png")));
		...
		buttonSeven23.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("jardinBotanico");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel24.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 5/lbllunaPark.png")));
		...
		jLabel25.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/EdificiosComunitarios/Nivel 5/lblobservatorio.png")));
	...
	public static void setSeleccionada(String seleccionada) {
		DialogoEdifComunitarios.seleccionada = seleccionada;
	}
	...
	public static void setVivienda(Construccion vivienda) {
		DialogoEdifComunitarios.vivienda = vivienda;
	}
	...
	public static void main(String[] args) {
		...
		DialogoEdifComunitarios dialogo = new DialogoEdifComunitarios(frame,
				false);
