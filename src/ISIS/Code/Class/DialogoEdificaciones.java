 ...
 * @author Jose
 */
public class DialogoEdificaciones extends javax.swing.JDialog {

	/**
	 * Creates new form Dialogo
	 */
	public DialogoEdificaciones(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
	...
	private void initComponents() {
		...
		lblEdif1.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 1/lblPetrocasa.png")));
		...
		lblEdif2.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 1/lblMajunche.png")));
		...
		lblEdif3.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 1/lblCabana.png")));
		...
		lblEdif4.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 1/lblRancho.png")));
		...
		lblEdif5.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 1/lblPalafito.png")));
		...
		buttonSeven6.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("bloquesBolivarianos");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		buttonSeven9.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("casitaBailadores");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel11.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 3/lblapartamentosRodeo.png")));
		...
		buttonSeven11.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("apartamentosRodeo");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel12.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 3/lblcasaPava.png")));
		...
		jLabel13.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 3/lblcasaSifri.png")));
		...
		jLabel14.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 3/lblnarcoCasa.png")));
		...
		jLabel16.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 4/lblapartamentoMercedes.png")));
		...
		buttonSeven16.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("apartamentoMercedes");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel17.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 4/lblcasaMollejua.png")));
		...
		jLabel18.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 4/lblcasaVieja.png")));
		...
		jLabel19.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 4/lblpenhouseChacao.png")));
		...
		buttonSeven19.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("penhouseChacao");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel20.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 4/lblquintaAissami.png")));
		...
		jLabel21.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 5/lblapartamentoAltamira.png")));
		...
		buttonSeven21.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("apartamentoAltamira");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel22.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 5/lblcasaRicos.png")));
		...
		jLabel23.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 5/lblmansionAltamira.png")));
		...
		buttonSeven23.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("mansionAltamira");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		...
		jLabel24.setIcon(new javax.swing.ImageIcon(
				ImageCache
						.getInstance()
						.getImage(
								"src/ISIS/Resource/MenuCompra/Edificaciones/Nivel 5/lblmansionFloresta.png")));
		...
		buttonSeven24.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("mansionFloresta");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
	...
	public static void setSeleccionada(String seleccionada) {
		DialogoEdificaciones.seleccionada = seleccionada;
	}
	...
	public static void setVivienda(Construccion vivienda) {
		DialogoEdificaciones.vivienda = vivienda;
	}
	...
	public static void main(String[] args) {
		...
		DialogoEdificaciones dialogo = new DialogoEdificaciones(frame, false);
	...
	public static org.edisoncor.gui.tabbedPane.TabbedSelector2 tabbedSelector21;
