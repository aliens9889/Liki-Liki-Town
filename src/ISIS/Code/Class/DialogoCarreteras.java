...
public class DialogoCarreteras extends JDialog {

	public DialogoCarreteras(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
	...
	private void initComponents() {
		System.out.println("incia componentes dialogoVias");
		...
		buttonSeven1.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				setSeleccionada("carretera1");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		});
		buttonSeven1.setVisible(true);

		jLabel1.setIcon(new javax.swing.ImageIcon(
				ImageCache
				.getInstance()
				.getImage(
						"src/ISIS/Resource/MenuCompra/Carreteras/Nivel 1/lblCarretera1.png")));
		...
		jLabel2.setIcon(new javax.swing.ImageIcon(
				...
				.getInstance()
				.getImage(
						"src/ISIS/Resource/MenuCompra/Carreteras/Nivel 1/lblCarretera2.png")));
		...
		buttonSeven2.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("carretera2");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		});
		buttonSeven2.setVisible(true);

		jLabel3.setIcon(new javax.swing.ImageIcon(
				ImageCache
				.getInstance()
				.getImage(
						"src/ISIS/Resource/MenuCompra/Carreteras/Nivel 1/lblCarretera3.png")));
		...
		buttonSeven3.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				gamepanel.mouseClicked(evt);
				gamepanel.setClick(true);
				setSeleccionada("carretera3");
				Mapa.objeto = new Construccion(getSeleccionada());
				Mapa.ESTADO = Estados.CONSTRUCCION;
				repaint();
			}
		});
		buttonSeven3.setVisible(true);

//		jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource(
//				"/MenuCompra/Vias/lblVia4.png"))); // NOI18N
...
//		});
	...
	public static void setSeleccionada(String seleccionada) {
		DialogoCarreteras.seleccionada = seleccionada;
	}
	...
	public static void main(String[] args) {
		...
		DialogoCarreteras dialogo = new DialogoCarreteras(frame, false);
