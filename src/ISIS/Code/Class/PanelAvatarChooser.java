...
public class PanelAvatarChooser extends Panel {
	...
	private List<Avatar> getSampleAvatar() {
		...
		avatares.add(new Avatar(
				"Er' Conde",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/conde.png")));
		avatares.add(new Avatar(
				"Charlie Mata",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/charlie.png")));
		avatares.add(new Avatar(
				"Chavito",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/Chavez.png")));
		avatares.add(new Avatar(
				"Jaime Lusinchi",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/lusinchi.png")));
		avatares.add(new Avatar(
				"Capriles",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/capriles.png")));
		avatares.add(new Avatar(
				"Manuel Rosales",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/rosales.png")));
		avatares.add(new Avatar(
				"Carlos A. Perez",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/Perez.png")));
		avatares.add(new Avatar(
				"Rafa Caldera",
				(BufferedImage) loadImage("/ISIS/Resource/MayorsImages/chunior.png")));
		return avatares;
	}
	...
	private static Image loadImage(String fileName) {
		try {
			return ImageIO.read(PanelAvatarChooser.class.getResource(fileName));
