...
public class PanelAtencion extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		add(buttonSeven3);
		buttonSeven3.setBounds(Toolkit.getDefaultToolkit()
				.getScreenSize().getSize().width-100, Toolkit.getDefaultToolkit()
				.getScreenSize().getSize().height-90, 116, 35);
		...
		add(jLabel1);
		jLabel1.setBounds(50, 20, Toolkit.getDefaultToolkit()
				.getScreenSize().getSize().width, Toolkit.getDefaultToolkit()
				.getScreenSize().getSize().height);
